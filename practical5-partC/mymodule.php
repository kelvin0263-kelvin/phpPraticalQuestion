<?php
$apiUrl = "http://192.168.100.103:106/tarumt/ip/practical5/example/subject_api.php";
$message = "";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($actionType === 'add') {
        ...
        $ch = curl_init("$apiUrl?action=add");
...
// Always fetch all subjects after actions
...
<tr><th>ID</th><th>Code</th><th>Title</th><th>Credit</th><th>Year</th><th>Actions</th></tr>
